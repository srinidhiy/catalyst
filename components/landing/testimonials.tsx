            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ Our researchers will miss their timelines if they don’t get their supplies, pushing back progress weeks or even months. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">David Meek</cite>
                <div className="text-gray-600">
                  <span></span> <a className="text-blue-600 hover:underline" href="#0">Biotech CEO</a>
                </div>
              </div>
