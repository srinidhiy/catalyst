        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Data Visualization</h4>
              <p className="text-gray-600 text-center">Ensures precise financial allocation and prevents overspending in wrong areas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Personalized Optimization</h4>
              <p className="text-gray-600 text-center">Wealth of data informs optimal reordering times and price points.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Quick and Easy Onboarding</h4>
              <p className="text-gray-600 text-center">Easily upload your current inventory databases to get started.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Request and Manage Supplies</h4>
              <p className="text-gray-600 text-center">No more time wasted managing inventory; everything is at your fingertips.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Contact Catalyst's dedicated support team whenever for assistance or inquiries.</p>
            </div>
