...
export const pieChartOptions: ApexGeneric = {
  labels: ["NSF Grant", "USC", "Venture Capitalist"],
  colors: ["#0052FF", "#0052FF", "#0052FF"],
  chart: {
    width: "50px",
  },
  states: {
...
export const pieChartData = [52, 28, 20];




export const InvpieChartOptions: ApexGeneric = {
  labels: ["Adequate Stock", "Low-Moderate Stock", "At Risk of Depletion"],
  colors: ["#0052FF", "#0052FF", "#0052FF"],
  chart: {
    width: "50px",
  },
...
export const InvpieChartData = [74, 21, 5];
