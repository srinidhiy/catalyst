...
import { lineChartDataTotalSpent, lineChartOptionsTotalSpent } from '@/components/dashboard/variables/charts';
			...
			<Flex w='100%' flexDirection={{ base: 'column', lg: 'row' }}>
				<Flex flexDirection='column' me='20px' mt='28px'>
					...
					<Flex align='center' mb='20px'>
						...
						<Flex align='center'>
							<Icon as={RiArrowUpSFill} color='#45B745' me='2px' mt='2px' />
							<Text color='#45B745' fontSize='sm' fontWeight='700' lineHeight='100%'>
								+2.45%
							</Text>
						</Flex>
					</Flex>
					...
					<Flex align='center'>
						...
						<Text color='#45B745' fontSize='md' fontWeight='700'>
							On track
						</Text>
					</Flex>
				</Flex>
